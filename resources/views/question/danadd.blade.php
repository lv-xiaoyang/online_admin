...
<form class="form-horizontal" role="form">
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">题目类型</label>
	    <div class="col-sm-10">
	    	          <input type="radio" class="question_diff" name="question_type_id" value="1" checked>单选题
                  <input type="radio" class="question_diff" name="question_type_id" value="2">多选题
  ...
  <!--   <div class="form-group">
    ...
    <div class="form-group">
      <label for="firstname" class="col-sm-2 control-label">正确答案</label>
        <div class="col-sm-10">
          <div>
                  <label><input type="radio" class="question_cor" name="question_cor" value="A" checked>A</label>
                  <label><input type="radio" class="question_cor" name="question_cor" value="B">B</label>
                  <label><input type="radio" class="question_cor" name="question_cor" value="C">C</label>
                  <label><input type="radio" class="question_cor" name="question_cor" value="D">D</label>
          </div>
        </div>
    </div>
