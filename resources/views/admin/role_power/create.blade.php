                                                            ...
                                                            <div class="form-select-list">
                                                                <select class="form-control custom-select-value" id="roles" name="account">
                                                                    ...
                                                                    @if(!empty($roles_data))
                                                                        ...
                                                                        <option value="{{$v->ro_id}}">{{$v->ro_name}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-10 col-sm-10 col-xs-10">
                                                                        ...
                                                                        @if(!empty($power_data))
                                                                            ...
                                                                            <label>
                                                                                <input type="checkbox" class="power" value="{{$v->pow_id}}"> <i></i>{{$v->pow_name}}</label>
                                                                            @endforeach
                                                                        @endif
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="login-horizental cancel-wp pull-left">
                                                                    ...
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" id="sub" type="button">添加</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
